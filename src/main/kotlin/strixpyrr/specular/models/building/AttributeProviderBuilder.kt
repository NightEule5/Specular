...
import strixpyrr.specular.models.getEmptyAttributeContainer
import uy.klutter.core.common.with

abstract class AttributeProviderBuilder<L> : IAttributeProviderBuilder<L>
{
	override var attributeContainer: IAttributeContainer<L> = getEmptyAttributeContainer();
	
	override fun setAttributeContainer(builder: IAttributeContainerBuilder<L>)
		= setAttributeContainer(builder.build());
