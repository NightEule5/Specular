 ...
 * @since 0.5
 */
open class NamedAttributeContainerBuilder protected constructor(
	storage: MutableMap<String, Any?>,
	val isCaseSensitive: Boolean
) : AttributeContainerBuilder<String>(storage)
{
	constructor(
		initialCapacity: Int = 8,
		keepInsertionOrder: Boolean = true,
		isCaseSensitive: Boolean = false
	) : this(storageMap(initialCapacity, keepInsertionOrder), isCaseSensitive)
